        ...
        <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-6">
                ...
                <div className="bg-[var(--background)] flex flex-wrap justify-center gap-5 p-4 rounded-[8px]">
                    <Image src={'/images/text.png'} width={90} height={30} alt="recaptcha" />
                    <Input placeholder="Tekshiruv kodini kiriting" className="flex-1 max-w-[250px]" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <a href="#">
                        <Button className="w-full">
                            <Image src={'/icons/one-id.svg'} width={32} height={21} alt="One ID" /> OneID orqali kirish
                        </Button>
                    </a>
                </div>
            </div>
